...
enum Types
{
	...
	resc = 0x72657363, resd = 0x72657364, rtng = 0x72746e67, sbgp = 0x73626770,
	schi = 0x73636869, schm = 0x7363686d, scpt = 0x73637074, sdep = 0x73646570,
	sdhd = 0x73646864, sdtp = 0x73647470, sdvp = 0x73647670, segr = 0x73656772,
	senc = 0x73656e63, sgpd = 0x73677064, sidx = 0x73696478, sinc = 0x73796e63,
	sinf = 0x73696e66, skip = 0x736b6970, smhd = 0x736d6864, srmb = 0x73726d62,
	srmc = 0x73726d63, srpp = 0x73727070, ssrc = 0x73737263, stbl = 0x7374626c,
	stco = 0x7374636f, stdp = 0x73746470, sthd = 0x73746864, stsc = 0x73747363,
	stsd = 0x73747364, stsh = 0x73747368, stss = 0x73747373, stsz = 0x7374737a,
	stts = 0x73747473, styp = 0x73747970, stz2 = 0x73747a32, subs = 0x73756273,
	swtc = 0x73777463, tfad = 0x74666164, tfhd = 0x74666864, tfma = 0x74666d61,
	tfra = 0x74667261, tibr = 0x74696272, tiri = 0x74697269, titl = 0x7469746c,
	tkhd = 0x746b6864, tmcd = 0x746d6364, traf = 0x74726166, trak = 0x7472616b,
	tref = 0x74726566, trex = 0x74726578, trgr = 0x74726772, trik = 0x7472696b,
	trun = 0x7472756e, tsel = 0x7473656c, udta = 0x75647461, uinf = 0x75696e66,
	UITS = 0x55495453, ulst = 0x756c7374, uuid = 0x75756964, vmhd = 0x766d6864,
	vwdi = 0x76776469, wide = 0x77696465, yrrc = 0x79727263
};
